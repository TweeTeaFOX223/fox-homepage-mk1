...
export default function BaseProfile() {
  return (
    <div className="container mx-auto p-4 max-w-6xl">
      {/* ヘッダー */}
      <div className="relative mb-8 overflow-hidden rounded-xl bg-gradient-to-br from-emerald-500/10 via-teal-500/10 to-cyan-500/10 p-6 border-2 border-emerald-500/20">
        ...
        <h1 className="relative text-3xl md:text-4xl font-black text-center bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 bg-clip-text text-transparent">
          個人開発者「T2フォックス」
        </h1>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        ...
        {/* 右側カラム - SNSリンク */}
        <div className="relative overflow-hidden rounded-xl border-2 border-emerald-500/20 bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10 p-6">
          ...
          <div className="relative grid grid-cols-10 gap-3 content-start h-full">
            {/* X(Twitter) - 7列 */}
            <div className="col-span-7 border-2 border-[#1DA1F2]/30 rounded-lg bg-gradient-to-r from-[#1DA1F2]/5 to-[#1DA1F2]/10 hover:from-[#1DA1F2]/20 hover:to-[#1DA1F2]/30 hover:border-[#1DA1F2]/60 transition-all duration-300 hover:shadow-lg hover:shadow-[#1DA1F2]/20 hover:-translate-y-1">
              <a
            ...
            {/* Twilog - 3列 */}
            <div className="col-span-3 border-2 border-[#00BFFF]/30 rounded-lg bg-gradient-to-r from-[#00BFFF]/5 to-[#00BFFF]/10 hover:from-[#00BFFF]/20 hover:to-[#00BFFF]/30 hover:border-[#00BFFF]/60 transition-all duration-300 hover:shadow-lg hover:shadow-[#00BFFF]/20 hover:-translate-y-1">
              <a
