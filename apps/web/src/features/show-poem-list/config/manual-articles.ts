...
export const manualArticles: ManualArticleItem[] = [
  {
    url: "https://note.com/tweeteafox300/n/nb3794b04e5d3",
    title: "汎用的！あらゆる分野の情報収集で使えるテクニック＆基本的な考え方 ",
    description:
